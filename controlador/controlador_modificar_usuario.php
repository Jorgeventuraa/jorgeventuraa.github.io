...
if (!empty($_POST["btnmodificar"])) {
    ...
    if (!empty($_POST["txtapellidopaterno"]) and !empty($_POST["txtapellidomaterno"]) and !empty($_POST["txtnombres"]) and !empty($_POST["txtusuario"]) ) {
        ...
        <?php } else {
            ...
            $modificar=$conexion->query(" update usuario set apellido_paterno='$apellidopaterno', apellido_materno='$apellidomaterno', nombre='$nombre ', usuario='$usuario' where id_usuario=$id");
