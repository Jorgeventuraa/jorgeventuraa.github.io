    ...
    <div class="search-field ">
      <form class="d-flex align-items-center h-100" name="search" action="search_visitor.php" method="post" >
        <div class="input-group" style="background-color: #f2edf3;">
          <input type="text" class="form-control bg-transparent border-0"name="searchdata" id="searchdata" placeholder="Buscar por nombres &amp; telefono" required="true" >
        </div>
    ...
    <li class="nav-item nav-profile dropdown">
      ...
      <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
        <a class="dropdown-item" href="profile.php">
          ...
          <a class="dropdown-item" href="change_password.php"><i class="mdi mdi-settings mr-2 text-success"></i> Cambiar Contraseña </a>
          <div class="dropdown-divider"></div>
