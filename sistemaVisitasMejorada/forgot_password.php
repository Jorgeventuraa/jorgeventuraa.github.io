          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h6 class="font-weight-light">Por favor ingrese a detalle el motivo para restablecer tu password a continuación.</h6>
                <form class="js-validation-signin px-30" method="post" name="chngpwd" onSubmit="return valid();">
                    ...
                    <div class="form-group row">
                        <div class="col-12">
                            <div class="form-material floating">
                                ...
                                <label for="login-password">Número de teléfono</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Tengo Cuenta <a href="index.php" class="text-primary">haga clic aquí</a>
                  </div>
                </form>
              </div>
            </div>
