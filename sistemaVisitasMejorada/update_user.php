...
?>
<div class="card-body">
  <h4 class="card-title">Actualizar formulario de usuario</h4>
  <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    if($query->rowCount() > 0)
    {
      ...
      { 
        ...
        <div class="form-group">
          ...
          <input type="text" name="phone2" class="form-control" id="phone2" maxlength="9" value="<?php  echo $row->MobileNumber;?>"  required>
        </div>
        <div class="form-group">
    ...
    <button type="submit" name="saveupdates" class="btn btn-primary btn-fw mr-2">Actualizar</button>
